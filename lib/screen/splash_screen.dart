  ...
  void initState() {
    ...
    Timer(Duration(seconds: 5), () {
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder: (context) =>
              CurvertorMainPage(currenciesFuture: currencies, rateFuture: rate),
        ),
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        builder: (context, size, widget) {
          return Center(
            child: Column(
              ...
              children: [
                SizedBox(height: Dimension.screenHeight / 2.5),
                Container(
                ...
                SizedBox(height: Dimension.screenHeight / 2.8),
              ],
            ),
          );
        },
      ...
      bottomNavigationBar: Container(
        height: Dimension.heightFactor * 60,
          ...
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(width: Dimension.widthFactor * 4),
                Icon(
                  Icons.favorite,
                  color: AppColors.textFieldColor,
                  size: 14,
